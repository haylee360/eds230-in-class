...
str(sens_Catm_Sobol)
```
You gave it X1 and X2, Sobol is gonna give you X: the parameter sets it wants you to run the model for. It bases that on the variance structure of the samples (X1, X2) you gave it. 
...
Sobol gave you back 6000 rows, res is also 6000. Sobol figures out how many parameter sets you should run based on input parameters. 
